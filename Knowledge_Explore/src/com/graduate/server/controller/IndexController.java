...
public class IndexController {
	...
	public Result getIndex(String query,String relation,String  direction){
		...
		List<Entity>entityList=service.getQueryEntity(list,null);
		/*for(Entity entity:entityList) {
			System.out.println(entity.getName()+" "+entity.getScore());
		}*/
		List<Feature>featureList=service.getFeature(queryList,directionList,relationList,null);
		/*for(String name:list){
			DataLoad.InputType.put(name, 1);
		}*/
		//List<Entity> querylist=new ArrayList<Entity>();
		List<Entity>entityList1=service.getQueryEntity(list);
		service.saveQuery(entityList1);
